...
const reviewSymbol = Symbol("review"); // Уникальный индификатор  перевод " обзор "
const ratingSymbol = Symbol("rating"); // райтинг
const tagsSymbol = Symbol("tags"); //  теги
...
console.log(book);
book.addMetadata(ratingSymbol, "Книга отстой, не покупайте ее.");
console.log(book);
